...
wires-menu-help-popup =
    Нажмите на золотые контакты, держа в руке мультитул, чтобы прозвонить их провод.
    Нажмите на провода, держа в руке кусачки, чтобы перерезать или соединить их.
    
    Индикаторы сверху показывают состояние машины; ковыряние проводов, вероятно, на них повлияет.
    Разводка проводов каждый раунд разная, но одинакова для машин одного типа.
